...
describe('SanitizePipe', () => {
  ...
  it('transform html', () => {
    const htmlElm = `<iframe class="w-100" src="https://www.youtube.com/embed/KS76EghdCcY?rel=0&ampcontrols=0" frameborder="0" allow="autoplay encrypted-media" allowfullscreen></iframe>`
