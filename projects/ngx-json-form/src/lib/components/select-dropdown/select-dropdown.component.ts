import { AfterViewInit, ChangeDetectorRef, Component, ElementRef, EventEmitter, HostBinding, HostListener, Input, OnChanges, OnInit, Output, QueryList, SimpleChanges, TemplateRef, ViewChild, ViewChildren, ViewEncapsulation, forwardRef } from '@angular/core'
...
constructor(private cdref: ChangeDetectorRef, public _elementRef: ElementRef, private dropdownService: SelectDropdownService) {
  this.multiple = false
...
/**
 * When selected items changes trigger the change back to parent
 */
public valueChanged() {
